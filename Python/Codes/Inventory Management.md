...
              background = [("selected", "#93C5FD")], foreground = [("selected", "black")])
...
            messagebox.showwarning("Warning","Please select a comodity.")

            return

        answer = messagebox.askyesno("Delete", "Are you sure you want to delete this comodity?")
